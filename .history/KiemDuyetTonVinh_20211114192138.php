                                            ...
                                            <td colspan="11">
                                                <div class="grp-btn" style="display: flex;">
                                                    ...
                                                    if ($row1['dem'] == 0) {
                                                        ...
                                                        <a href="ThemApplyTonVinh.php?id_nguoihienmau=<?php echo $row1['ID_NguoiHienMau'] ?>&muctonvinh=<?php echo $muctonvinh ?>&madonvi=<?php echo $madonvi ?>&matonvinh=<?php echo $matonvinh ?>" class="btn btn-danger" id="btnApply<?php echo $row1['ID_NguoiHienMau'] ?>">
                                                            <b>Apply</b>
                                                        </a>
