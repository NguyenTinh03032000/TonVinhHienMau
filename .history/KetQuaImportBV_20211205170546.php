...
<head>
    ...
    <title>Kết quả import bệnh viện</title>
    <meta charset="utf-8">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: inherit;">
                                                    ...
                                                    ?>
                                                    <a href="XoaImportBV_1.php?nguoihienmau=<?php echo urlencode(serialize($nguoihienmau)) ?>" class="btn btn-danger btnXuLy" style="margin: 0px;">XÓA</a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="12">
                                                    <div class="nav justify-content-end">
                                                        ...
                                                        ?>
                                                        <a href="ThemImportBV.php?nguoihienmau=<?php echo urlencode(serialize($nguoihienmau)) ?>" class="btn btn-danger btnXuLy" style="margin: 0px; margin-right: 15px">THÊM</a>
