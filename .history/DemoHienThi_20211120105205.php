...
function KiemTraMucTonVinh($matonvinh)
{
    ...
    while ($rowMucTonVinh = mysqli_fetch_array($kqMucTonVinh)) {
        ...
        if ($rowMucTonVinh['MucTonVinh'] != "10") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "15") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "20") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "30") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "40") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "50") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "60") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "70") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "80") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "90") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] != "100") {
            echo "hidden";
        }
        if ($rowMucTonVinh['MucTonVinh'] == "null") {
            echo "hidden";
        }
    }
}
