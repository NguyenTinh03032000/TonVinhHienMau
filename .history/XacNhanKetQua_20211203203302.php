...
function TimKiem_1($matonvinh, $cbocboDonVi)
{
    include "bocuc/Connect.php";
    ...
    if ($cbocboDonVi == "null") {
        ...
        $sqldonvi = "SELECT DISTINCT donvi.madonvi, donvi.tendonvi FROM donvi INNER JOIN danhsachtonvinh ON donvi.madonvi = danhsachtonvinh.MaDonVi where danhsachtonvinh.MaTonVinh = '" . $matonvinh . "' and donvi.madonvi = '" . $cbocboDonVi . "' ORDER BY donvi.madonvi ASC";
    }
                        ...
                        <table class="table table-bordered">
                            ...
                            if ($_POST) {
                                if (isset($_POST['btnTimKiem']) and $_SERVER['REQUEST_METHOD'] == "POST") {
                                    TimKiem_1($matonvinh, $cbocboDonVi);
                                } else {
                                    TimKiem($matonvinh);
                                }
                            }
