                ...
                <div class="col-sm-10">
                    ...
                    ?>
                        ...
                        <ul class="nav nav-pills btnXuLy" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link btnThongTin" data-toggle="modal" data-target="#modalThem">THÊM ĐỢT TÔN VINH</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link btnThongTin" href="LichSuTonVinh_DanhSach.php">LỊCH SỬ TÔN VINH</a>
                            </li>
                        </ul>
                                ...
                                <table class="table-bordered">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn Xoa" data-toggle="modal" data-target="#modalXoa">
                            ...
                            <div class="modal fade" id="modalXoa">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <input hidden type="text" class="form-control" name="txtMaTonVinh_Xoa" id="txtMaTonVinh_Xoa">
...
<script>
    ...
    $(document).ready(function() {
        $('.Xoa').on('click', function() {
            ...
            console.log(data);
            $('#txtMaTonVinh_Xoa').val(data[1].trim());
        });
    });
</script>
...
function ThemDotTonVinh($dateNgayTonVinh)
{
    ...
    if ($dateNgayTonVinh == "") {
        ...
        // echo "<h1>" . $matonvinh . "</h1>";

        // $sqlKT = "select * from tonvinh where matonvinh = '$matonvinh' limit 1";
        // $kqKT = mysqli_query($kn, $sqlKT) or die("Lỗi truy vấn kiểm tra mã tôn vinh");
        // $rowKT = mysqli_fetch_array($kqKT);

        // if ($rowKT['matonvinh'] == $matonvinh) {
        //     echo "<h1>" . $rowKT['matonvinh'] . "</h1>";
        // } else {
        //     echo "<h1>" . $rowKT['matonvinh'] . " - Hello</h1>";
        // }

        $sqlKiemTra = "select * from tonvinh where matonvinh = '" . $matonvinh . "'";
        $kqKiemTra = mysqli_query($kn, $sqlKiemTra) or die("Lỗi truy vấn kiểm tra");
        while ($rowKiemTra = mysqli_fetch_array($kqKiemTra)) {
            // if ($rowKiemTra['matonvinh'] == $matonvinh) {
            //     echo "<script>alert('Thông tin đợt tôn vinh đã tồn tại trong hệ thống');</script>";
            // } else {
            ...
            echo "<h1>" . $rowKiemTra['matonvinh'] . " - hello</h1>";
        }
