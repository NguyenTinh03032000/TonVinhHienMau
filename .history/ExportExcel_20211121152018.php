...
$activeSheet->getStyle('A3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('C3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('D3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('E3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('H3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('I3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('J3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('K3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('L3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('M3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('N3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('O3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('P3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('Q3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('R3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('S3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
$activeSheet->getStyle('T3')->getAlignment()->setVertical(Alignment::HORIZONTAL_CENTER);
...
while ($rowdonvi = mysqli_fetch_array($kqdonvi)) {
    ...
    $activeSheet->mergeCells('B' . $count . ':G' . $count);
