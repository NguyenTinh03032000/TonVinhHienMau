                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Mã đăng nhập:</p>
                                                <input type="text" class="form-control" name="txtUsername_chitiet" style="pointer-events: none">
                                            </div>
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Họ và tên:</p>
                                                <input type="text" class="form-control" name="txtTen_chitiet" style="pointer-events: none">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Ngày sinh:</p>
                                                <input type="date" class="form-control" name="dateNgaysinh_chitiet">
                                            </div>
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Địa chỉ:</p>
                                                <input type="text" class="form-control" name="txtDiaChi_chitiet" style="pointer-events: none">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Số điện thoại:</p>
                                                <input type="text" class="form-control" name="txtSDT_chitiet" style="pointer-events: none">
                                            </div>
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Email:</p>
                                                <input type="email" class="form-control" name="txtEmail_chitiet" placeholder="name@example.com" style="pointer-events: none">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12" style="justify-content: center;display: block;">
                                                <p>Quyền đăng nhập:</p>
                                                <select class="form-control" name="cboMucTonVinh_chitiet" id="cboMucTonVinh">
                                                    <option value="" selected="selected">-- Chọn mức tôn vinh --</option>
                                                    <option value="0" selected="selected">Quyền quản lý thông tin</option>
                                                    <option value="1" selected="selected">Quyền người dùng</option>
                                                </select>
