...
function LoadDuLieu($cboHuyen, $cboSoLanHM, $cboMucTonVinh, $cboNhomMau, $txtTimKiem)
{
    ...
    if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null") {
        $diachi = "%" . $cboHuyen . "%";
    ...
    if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboMucTonVinh != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
    ...
    if ($cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
    ...
    if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
