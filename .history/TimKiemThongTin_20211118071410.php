                    ...
                    <form action="" method="POST">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered border border-danger" style="text-align: center" id="myTable">
                                <tr>
                                    <td>STT</td>
                                    <td hidden>Mã hiến máu</td>
                                    <td>Họ tên</td>
                                    <td style="width: 107px;">Ngày sinh</td>
                                    <td>Số điện thoại</td>
                                    <td style="width: 154px;">Địa chỉ</td>
                                    <td>Nơi làm việc</td>
                                    <td style="width: 95px;">Số lần hiến máu</td>
                                    <td style="witdh: 10px;">Nhóm ABO</td>
                                    <td style="width: 105px;">Nhóm Rh</td>
                                    <td>Đề xuất tôn vinh</td>
                                    <td style=" width: 140px;">Đã tôn vinh</td>
                                    <td>Cập nhật</td>
                                </tr>
                                <?php
                                if ($_POST) {
