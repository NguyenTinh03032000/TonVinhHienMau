                ...
                <div class="row bg-item">
                    ...
                    <div class="col-lg-10" style="margin-top:30px; margin-bottom:30px;">
                        ...
                        <div class="grp-btn">
                            ...
                            <a href="DuyetTonVinh.php" class="btn btn-danger">
                                <b>Kết quả</b>
                            </a>
                        </div>
                        <br>
                            ...
                            <table class="table table-bordered ">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $sql_ring = "select *, count(HoTen) as dem from nguoihienmau where HoTen='" . $row['HoTen'] . "' and NgaySinh='" . $row['NgaySinh'] . "' and NhomMau='" . $row['NhomMau'] . "'";
                                            $kq_ring = mysqli_query($kn,  $sql_ring);
                                            $row_ring = mysqli_fetch_array($kq_ring);
                                            if ($row_ring['HoTen'] == null) {
                                                echo '<img style="width: 30px;" src="style/ring.png">';
                                            }
                                            ?>
                                        </td>
