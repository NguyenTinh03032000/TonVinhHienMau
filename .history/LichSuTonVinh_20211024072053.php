                                ...
                                <table class="table-bordered">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btnThem" data-toggle="modal" data-target="#modalCapNhat">CẬP NHẬT ĐỢT TÔN VINH</button>
                                                    ...
                                                    <div class="modal fade" id="modalCapNhat">
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Cập nhật đợt tôn vinh</h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-primary" data-dismiss="modal">Thoát</button>
                                                                    <button type="submit" class="btn btn-secondary btnThem1" name="btnCapNhat">Cập nhật</button>
                                                                </div>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btnThem" data-toggle="modal" data-target="#modalXoa">THÊM ĐỢT TÔN VINH</button>
                                                    ...
                                                    <div class="modal fade" id="modalXoa">
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Xóa đợt tôn vinh</h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>
