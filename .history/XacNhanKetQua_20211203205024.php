...
function TongMuc_1($matonvinh, $muctonvinh, $cboDonVi)
{
    include "bocuc/Connect.php";
    $sql = "SELECT DISTINCT donvi.madonvi, donvi.tendonvi,
                        COUNT(case when danhsachtonvinh.MucTonVinh = '5' then 1 else null end) as Muc5, 
                        ...
                        FROM danhsachtonvinh INNER JOIN donvi ON donvi.madonvi = danhsachtonvinh.MaDonVi 
                                            INNER JOIN nguoihienmau ON nguoihienmau.ID_NguoiHienMau = danhsachtonvinh.ID_NguoiHienMau 
                                            INNER JOIN tonvinh on tonvinh.matonvinh = danhsachtonvinh.MaTonVinh 
                                            WHERE tonvinh.matonvinh = '" . $matonvinh . "' and donvi.madonvi = '" . $cboDonVi . "'";
    $kq = mysqli_query($kn, $sql) or die("lỗi truy vấn");
    $row = mysqli_fetch_array($kq);
...
function TimKiem_1($matonvinh, $cboDonVi)
{
    include "bocuc/Connect.php";
    ...
    if ($cboDonVi == "null") {
        ...
        $sqldonvi = "SELECT DISTINCT donvi.madonvi, donvi.tendonvi FROM donvi INNER JOIN danhsachtonvinh ON donvi.madonvi = danhsachtonvinh.MaDonVi where danhsachtonvinh.MaTonVinh = '" . $matonvinh . "' and donvi.madonvi = '" . $cboDonVi . "' ORDER BY donvi.madonvi ASC";
    }
    ...
    if ($cboDonVi == "null") {
        ...
        $tongmuc5_1 = TongMuc($matonvinh, 5);
        $tongmuc10_1 = TongMuc($matonvinh, 10);
        $tongmuc15_1 = TongMuc($matonvinh, 15);
        $tongmuc20_1 = TongMuc($matonvinh, 20);
        $tongmuc30_1 = TongMuc($matonvinh, 30);
        $tongmuc40_1 = TongMuc($matonvinh, 40);
        $tongmuc50_1 = TongMuc($matonvinh, 50);
        $tongmuc60_1 = TongMuc($matonvinh, 60);
        $tongmuc70_1 = TongMuc($matonvinh, 70);
        $tongmuc80_1 = TongMuc($matonvinh, 80);
        $tongmuc90_1 = TongMuc($matonvinh, 90);
        $tongmuc100_1 = TongMuc($matonvinh, 100);
    } else {
        $sqlTong = "SELECT COUNT(nguoihienmau.ID_NguoiHienMau) as Tong FROM danhsachtonvinh 
                    INNER JOIN donvi ON donvi.madonvi = danhsachtonvinh.MaDonVi 
                    INNER JOIN nguoihienmau ON nguoihienmau.ID_NguoiHienMau = danhsachtonvinh.ID_NguoiHienMau 
        ...
        $tongmuc5_1 = TongMuc($matonvinh, 5, $cboDonVi);
        $tongmuc10_1 = TongMuc($matonvinh, 10, $cboDonVi);
        $tongmuc15_1 = TongMuc($matonvinh, 15, $cboDonVi);
        $tongmuc20_1 = TongMuc($matonvinh, 20, $cboDonVi);
        $tongmuc30_1 = TongMuc($matonvinh, 30, $cboDonVi);
        $tongmuc40_1 = TongMuc($matonvinh, 40, $cboDonVi);
        $tongmuc50_1 = TongMuc($matonvinh, 50, $cboDonVi);
        $tongmuc60_1 = TongMuc($matonvinh, 60, $cboDonVi);
        $tongmuc70_1 = TongMuc($matonvinh, 70, $cboDonVi);
        $tongmuc80_1 = TongMuc($matonvinh, 80, $cboDonVi);
        $tongmuc90_1 = TongMuc($matonvinh, 90, $cboDonVi);
        $tongmuc100_1 = TongMuc($matonvinh, 100, $cboDonVi);
    }
    $kqTong = mysqli_query($kn, $sqlTong) or die("lỗi truy vấn");
    $rowTong = mysqli_fetch_array($kqTong);
    ...
    <form action="" method="POST">
        <div class="container-fluid" style="margin-top:30px; margin-bottom:30px;">
            ...
            <div class="row">
                ...
                <div class="col-sm-1">
                    <button type="submit" name="btnTimKiem" class="btn btn-danger">Tìm</button>
                </div>
            </div>
        </div>
