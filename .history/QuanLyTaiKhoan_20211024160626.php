                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12" style="justify-content: center;display: block;">
                                                <p>Quyền đăng nhập:</p>
                                                <select class="form-control" name="cboQuyen_chitiet" id="cboMucQuyen_chitiet">
                                                    <option value="" selected="selected">-- Chọn mức tôn vinh --</option>
                                                    <option value="0" selected="selected">Quyền quản lý thông tin</option>
                                                    <option value="1" selected="selected">Quyền người dùng</option>
                                                </select>
...
<script>
    ...
    $(document).ready(function() {
        $('.ChiTiet').on('click', function() {
            ...
            $('#txtSDT_chitiet').val(data[4]);
            $('#txtEmail_chitiet').val(data[5]);
            $('#txtDiaChi_chitiet').val(data[6]);
            $('#cboQuyen_chitiet').val(data[8]);
        });
    });
