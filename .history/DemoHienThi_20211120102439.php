...
function KiemTraMucTonVinh($matonvinh)
{
    ...
    $sqldonvi = "SELECT danhsachtonvinh.MucTonVinh, muctonvinh.TenMuc FROM danhsachtonvinh INNER JOIN muctonvinh ON muctonvinh.ID = danhsachtonvinh.MucTonVinh WHERE danhsachtonvinh.matonvinh = '" . $matonvinh . "'";
