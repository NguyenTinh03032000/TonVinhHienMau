                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <script type="text/javascript">
                                                        function tinhhoatdong ' . $rowMuc3_1['
                                                        MaHoatDong '] . '() {
                                                            var hoatdong ' . $rowMuc3_1['
                                                            MaHoatDong '] . ' = document.getElementById("hoatdong' . $rowMuc3_1['MaHoatDong'] . '");
                                                            var giatrihoatdong ' . $rowMuc3_1['
                                                            MaHoatDong '] . ';
                                                            for (var i = 0; i < hoatdong ' . $rowMuc3_1['
                                                                MaHoatDong '] . '.length; i++) {
                                                                if (hoatdong ' . $rowMuc3_1['
                                                                    MaHoatDong '] . ' [i].selected) {
                                                                    giatrihoatdong ' . $rowMuc3_1['
                                                                    MaHoatDong '] . ' = hoatdong ' . $rowMuc3_1['
                                                                    MaHoatDong '] . ' [i].value;
                                                                    mang3_1.push(giatrihoatdong ' . $rowMuc3_1['
                                                                        MaHoatDong '] . ');
                                                                }
                                                            }
                                                            document.getElementById("hoatdong' . $rowMuc3_1['MaHoatDong'] . '").style.display = "none";
                                                            document.getElementById("diemhoatdong' . $rowMuc3_1['MaHoatDong'] . '").innerHTML = "Số điểm đã chọn: " + giatrihoatdong ' . $rowMuc3_1['
                                                            MaHoatDong '] . ';
                                                        }
                                                    </script>
