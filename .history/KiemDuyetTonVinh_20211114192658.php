                                            ...
                                            <td colspan="11">
                                                <div class="grp-btn" style="display: flex;">
                                                    ...
                                                    if ($row1['dem'] == 0) {
                                                        ...
                                                        <a href="ThemApplyTonVinh.php?id_excel=<?php echo $row['ID'] ?>&id_nguoihienmau=<?php echo $row1['ID_NguoiHienMau'] ?>&muctonvinh=<?php echo $muctonvinh ?>&madonvi=<?php echo $madonvi ?>&matonvinh=<?php echo $matonvinh ?>" class="btn btn-danger" id="btnApply<?php echo $row1['ID_NguoiHienMau'] ?>">
                                                            <b>Apply</b>
                                                        </a>
                                ...
                                <?php
                                        ...
                                        echo '<script type="text/javascript">
                                                function thaydoitonvinh' . $row1['ID_NguoiHienMau'] . '()
                                                {
                                                    ...
                                                    document.getElementById("btnApply_1' . $row1['ID_NguoiHienMau'] . '").innerHTML = "' . $chuoidau . '' . $row['ID'] . '' . $chuoigiua . '" + giatritonvinh' . $row1['ID_NguoiHienMau'] . ' + "' . $chuoicuoi . '";
                                                }
