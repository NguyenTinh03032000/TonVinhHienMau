...
// Chiều dài cột
$spreadsheet->getActiveSheet()->getColumnDimension('H')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('I')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('J')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('K')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('L')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('M')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('N')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('O')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('P')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('Q')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('R')->setWidth(1, 'cm');
$spreadsheet->getActiveSheet()->getColumnDimension('S')->setWidth(1, 'cm');
