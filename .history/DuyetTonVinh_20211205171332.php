                                                            ...
                                                            <tbody id="myTable">
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style=" vertical-align: inherit">
                                                                            <div>
                                                                                <a class="button button1" data-toggle="tooltip" data-placement="top"></a>
                                                                                <?php
                                                                                $sql7 = "select * from danhsachtonvinh where ID_NguoiHienMau = '" . $row['ID_NguoiHienMau'] . "' and MaDonVi = '" . $row['MaDonVi'] . "'";
