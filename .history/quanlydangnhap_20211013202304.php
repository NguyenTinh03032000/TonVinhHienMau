...
<body>
            ...
            for ($row = 2; $row < $highestRow; $row++) {
                ...
                if ($magv != '') {
                    $sqlThem = "insert into giangvien (MaSinhVien, HoTen, NgaySinh, GioiTinh, SDT, Email, MatKhau, MaKhoa, Quyen)
                                    values ('$magv', '$hoten', '$date', '$gioitinh', '$sdt', '$email', '$magv', '$MaKhoa','2')";
                    $kq2 = mysqli_query($kn, $sqlThem) or die("lỗi truy vấn");
                }
            }
            echo "<script>alert('Thêm thành công');</script>";
    ...
    if (isset($_POST['btnCapNhatThongTinGV'])) {
        ...
        $txtngaysinh2 = array_key_exists('dateNgaysinhGV2', $_POST) ? $_POST['dateNgaysinhGV2'] : null;
        $txtsdt2 = array_key_exists('txtSDTGV2', $_POST) ? $_POST['txtSDTGV2'] : null;
        $txtemail2 = array_key_exists('txtEmailGV2', $_POST) ? $_POST['txtEmailGV2'] : null;

        $sql1 = "update giangvien set MatKhau = '$txtmatkhau2', 
                                            NgaySinh = '$txtngaysinh2',
                                            SDT = '$txtsdt2',
                                            Email = '$txtemail2'
    ...
    if (isset($_POST['btnLuuSV'])) {
        ...
        $sqlLuu = "insert into sinhvien (MaSinhVien, HoTen, NgaySinh, GioiTinh, SDT, Email, MaLop, ChucVu, TinhTrangHoc, MatKhau, Quyen)
                    values ('$txtMSV', '$txtTen', '$dateNgaysinh', '$rdgioitinh', '$txtSDT', '$txtEmail', '$cboLop', '$cboChucvu', '$cbotinhtrang', '$txtMK', '$cboQuyen')";
    ...
    if (isset($_POST['btnLuuGV'])) {
        ...
        $sqlLuuGV = "insert into giangvien (MaGiangVien, HoTen, NgaySinh, GioiTinh, SDT, Email, MatKhau, MaKhoa, Quyen)
                    values ('$txtMSVGV', '$txtTenGV', '$dateNgaysinhGV', '$rdgioitinhGV', '$txtSDTGV', '$txtEmailGV', '$txtMKGV', '$MaKhoa','2')";
                ...
                ?>
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <ul class="nav nav-pills" role="tablist" style="justify-content: center;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#menu2">Tài khoản đăng nhập quản lý hoạt động</a>
                            </li>
                        </ul>
                        <br>
                        <!-- Tab panes -->
                                    ...
                                    <div class="modal fade" id="ThemGV">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Thêm tài khoản đăng nhập quản lý hoạt động</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                <!-- Nav tabs -->
                                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <div class="modal fade" id="CapNhatGV">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Cập nhật tài khoản đăng nhập quản lý hoạt động</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; vertical-align: inherit;" hidden>
                                                        <p style="margin: 7px auto; width: 80px;"><?php echo $row['MatKhau']; ?></p>
                                                    </td>
                                                    <td style="text-align: center; vertical-align: inherit;" hidden>
                                                        <p style="margin: 7px auto;"><?php echo $row['Quyen']; ?></p>
                                    ...
                                    <div class="modal fade" id="CapNhatThongTinGV">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Cập nhật thông tin quản lý hoạt động</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6" style="justify-content: center;display: block;">
                                                            <p>Ngày sinh:</p>
                                                            <input type="date" class="form-control" name="dateNgaysinhGV2" id="ngaysinh2">
                                                        </div>
                                                        <div class="col-sm-6" style="justify-content: center;display: block;">
                                                            <p>Số điện thoại:</p>
                                                            <input type="text" class="form-control" name="txtSDTGV2" id="sdt2">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6" style="justify-content: center;display: block;">
                                                            <p>Email:</p>
                                                            <input type="email" class="form-control" name="txtEmailGV2" id="email2" placeholder="name@example.com">
                                                        </div>
                                                        <div class="col-sm-6" style="justify-content: center;display: block;">
                                                            <p>Mật khẩu:</p>
                                                            <input type="text" class="form-control" name="txtmatkhau2" id="matkhau2">
                                                        </div>
                                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.CapNhatThongTinGV').on('click', function() {
            ...
            $('#ngaysinh2').val(data[2].trim());
            $('#sdt2').val(data[4].trim());
            $('#email2').val(data[5].trim());
    ...
    $(document).ready(function() {
        $('.ThongTinSV').on('click', function() {
            ...
            $('#masv3').val(data[0].trim());
            $('#tensv3').val(data[1].trim());
            $('#nssv3').val(data[2].trim());
            $('#gtsv3').val(data[3].trim());
            $('#sdtsv3').val(data[4].trim());
            $('#emailsv3').val(data[5].trim());
            $('#lopsv3').val(data[6].trim());
            $('#cnsv3').val(data[11].trim());
            $('#cvsv3').val(data[7].trim());
            $('#ttsv3').val(data[8].trim());
            $('#mksv3').val(data[9].trim());
        });
    });
