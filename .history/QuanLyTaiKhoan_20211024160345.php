                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12" style="justify-content: center;display: block;">
                                                <p>Quyền đăng nhập:</p>
                                                <select class="form-control" name="cboMucTonVinh_chitiet" id="cboMucTonVinh_chitiet">
                                                    <option value="" selected="selected">-- Chọn mức tôn vinh --</option>
                                                    <option value="0" selected="selected">Quyền quản lý thông tin</option>
                                                    <option value="1" selected="selected">Quyền người dùng</option>
                                                </select>
...
<script>
    ...
    $(document).ready(function() {
        $('.CapNhat').on('click', function() {
            ...
            console.log(data);
            $('#txtUsername_chitiet').val(data[1]);
            $('#txtTen_chitiet').val(data[2]);
            $('#dateNgaysinh_chitiet').val(data[3]);
            $('#txtDiaChi_chitiet').val(data[4]);
            $('#txtSDT_chitiet').val(data[5]);
            $('#txtEmail_chitiet').val(data[6]);
            $('#cboMucTonVinh_chitiet').val(data[7]);
        });
    });
