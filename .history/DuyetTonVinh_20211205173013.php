                                                        ...
                                                        <table class="table table-bordered table-hover" style="width:100%">
                                                            <thead>
                                                                <tr style="text-align: center">
                                                                    ...
                                                                    <th style="text-align: center; vertical-align: inherit; width: 95px">Số lần hiến máu</th>
                                                                    ...
                                                                    <th style="text-align: center; vertical-align: inherit; width: 160px;">Đề xuất tôn vinh</th>
                                                                    <th style="text-align: center; vertical-align: inherit; width: 140px;">Đã tôn vinh</th>
                                                                    <th style="text-align: center; vertical-align: inherit; width: 100px;">Cập nhật</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="myTable">
                                                                <?php
