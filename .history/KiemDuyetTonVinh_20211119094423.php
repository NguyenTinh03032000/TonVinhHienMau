                                                ...
                                                <div class="grp-btn" style="display: flex;">
                                                    ...
                                                    if ($row1['dem'] == 0) { ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            <?php echo $row['NgaySinh'] ?>&nhommau=<?php echo $row['NhomMau'] ?>&solanhienmau_excel=<?php echo $row['SoLanHienMau'] ?>&solanhienmau=<?php echo $row1['SoLanHienMau'] ?> " class="btn btn-danger btn-apply grp-btn" id="btnApply<?php echo $row1['ID_NguoiHienMau'] ?>">
                                                                <b>Apply</b>
                                                            </a>
