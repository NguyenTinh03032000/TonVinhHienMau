...
function KiemTraMucTonVinh($matonvinh, $muctonvinh)
{
    ...
    $sqlMucTonVinh = "SELECT DISTINCT danhsachtonvinh.MucTonVinh FROM danhsachtonvinh INNER JOIN muctonvinh ON muctonvinh.ID = danhsachtonvinh.MucTonVinh WHERE danhsachtonvinh.matonvinh = '" . $matonvinh . "' and muctonvinh.ID = '" . $muctonvinh . "'";
