...
function TimKiem_1($matonvinh, $cboDonVi)
{
    ...
    if ($cboDonVi == "null") {
        ...
        echo '<tr>
                ...
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 5, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 10, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 15, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 20, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 30, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 40, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 50, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 60, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 70, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 80, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 90, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc_1($matonvinh, 100, $cboDonVi) . '</h5>
                </td>
            </tr>
        </tbody>';
    }
    ...
    <form action="" method="POST">
        <div class="container-fluid" style="margin-top:30px; margin-bottom:30px;">
            ...
            <div class="row">
                ...
                <div class="col-sm-2" style="justify-content: center; display: flex;">
                    <button type="submit" class="btn btn-danger btn-block">Làm mới</button>
                </div>
                <div class="col-sm-1"></div>
            </div>
        </div>
                ...
                ?>
                    <div class="table-responsive-xl">
                        <table class="table table-bordered">
                            ...
                            } else if (isset($_POST['btnTimKiem']) and $_SERVER['REQUEST_METHOD'] == "POST") {
                                TimKiem_1($matonvinh, $cboDonVi);
                            } else {
                                TimKiem($matonvinh);
                            }
