                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered border border-danger" style="text-align: center" id="myTable">
                                <tr>
                                    ...
                                    <th style="width: 107px;" onclick="sortTable(3)">Ngày sinh</th>
                                    <th onclick="sortTable(4)">Số điện thoại</th>
                                    <th style="width: 154px;" onclick="sortTable(5)">Địa chỉ</th>
                                    <th onclick="sortTable(6)">Nơi làm việc</th>
                                    <th style="width: 95px;" onclick="sortTable(7)">Số lần hiến máu</th>
                                    <th style="width: 10px;" onclick="sortTable(8)">Nhóm ABO</th>
                                    <th style="width: 105px;" onclick="sortTable(9)">Nhóm Rh</th>
                                    <th onclick="sortTable(10)">Đề xuất tôn vinh</th>
                                    <th style=" width: 140px;" onclick="sortTable(11)">Đã tôn vinh</th>
                                    <th>Cập nhật</th>
                                </tr>
                                <?php
                                if ($_POST) {
