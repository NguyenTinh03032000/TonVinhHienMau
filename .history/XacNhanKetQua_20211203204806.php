...
function TimKiem_1($matonvinh, $cboDonVi)
{
    ...
    if ($cboDonVi == "null") {
        ...
        $tongmuc5 = TongMuc($matonvinh, 5);
        $tongmuc10 = TongMuc($matonvinh, 10);
        $tongmuc15 = TongMuc($matonvinh, 15);
        $tongmuc20 = TongMuc($matonvinh, 20);
        $tongmuc30 = TongMuc($matonvinh, 30);
        $tongmuc40 = TongMuc($matonvinh, 40);
        $tongmuc50 = TongMuc($matonvinh, 50);
        $tongmuc60 = TongMuc($matonvinh, 60);
        $tongmuc70 = TongMuc($matonvinh, 70);
        $tongmuc80 = TongMuc($matonvinh, 80);
        $tongmuc90 = TongMuc($matonvinh, 90);
        $tongmuc100 = TongMuc($matonvinh, 100);
    } else {
        $sqlTong = "SELECT COUNT(nguoihienmau.ID_NguoiHienMau) as Tong FROM danhsachtonvinh 
                    INNER JOIN donvi ON donvi.madonvi = danhsachtonvinh.MaDonVi 
                    INNER JOIN nguoihienmau ON nguoihienmau.ID_NguoiHienMau = danhsachtonvinh.ID_NguoiHienMau 
        ...
        $tongmuc5 = TongMuc($matonvinh, 5, $cboDonVi);
        $tongmuc10 = TongMuc($matonvinh, 10, $cboDonVi);
        $tongmuc15 = TongMuc($matonvinh, 15, $cboDonVi);
        $tongmuc20 = TongMuc($matonvinh, 20, $cboDonVi);
        $tongmuc30 = TongMuc($matonvinh, 30, $cboDonVi);
        $tongmuc40 = TongMuc($matonvinh, 40, $cboDonVi);
        $tongmuc50 = TongMuc($matonvinh, 50, $cboDonVi);
        $tongmuc60 = TongMuc($matonvinh, 60, $cboDonVi);
        $tongmuc70 = TongMuc($matonvinh, 70, $cboDonVi);
        $tongmuc80 = TongMuc($matonvinh, 80, $cboDonVi);
        $tongmuc90 = TongMuc($matonvinh, 90, $cboDonVi);
        $tongmuc100 = TongMuc($matonvinh, 100, $cboDonVi);
    }
    $kqTong = mysqli_query($kn, $sqlTong) or die("lỗi truy vấn");
    $rowTong = mysqli_fetch_array($kqTong);
