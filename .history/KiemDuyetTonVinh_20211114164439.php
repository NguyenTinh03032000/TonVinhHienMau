                                ...
                                <?php
                                        ...
                                        echo '<script type="text/javascript">
                                                function thaydoitonvinh' . $row1['ID_NguoiHienMau'] . '()
                                                {
                                                    ...
                                                    document.getElementById("btnApply_3' . $row1['ID_NguoiHienMau'] . '").innerHTML = ' . $chuoidau . '' . $row1['ID_NguoiHienMau'] . ''. $chuoigiua . 'giatritonvinh' . $row1['ID_NguoiHienMau'] . '' . $chuoicuoi ';
