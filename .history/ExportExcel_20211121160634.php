...
// Chiều dài cột
$activeSheet->getColumnDimension('H')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('I')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('J')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('K')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('L')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('M')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('N')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('O')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('P')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('Q')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('R')->setWidth(0.95, 'cm');
$activeSheet->getColumnDimension('S')->setWidth(0.95, 'cm');
