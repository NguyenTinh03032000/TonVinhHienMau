                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-2"><input type="text" class="form-control" value="<?php echo $row['hoten'] ?>"></div>
                                                <div class="col-lg-2"><input type="text" class="form-control"></div>
                                                <div class="col-lg-2"><input type="text" class="form-control" value="<?php echo $row['sdt'] ?>"></div>
                                                <div class="col-lg-2"><input type="text" class="form-control" value="<?php echo $row['diachi'] ?>"></div>
                                                <div class="col-lg-2"><input type="text" class="form-control" value="<?php echo $row['email'] ?>"></div>
                                            </div>
                                        </div>
