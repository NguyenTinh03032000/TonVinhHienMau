...
$activeSheet->getColumnDimension('C')->setWidth(10, 'pt');
$activeSheet->getColumnDimension('D')->setWidth(8, 'pt');
$activeSheet->getColumnDimension('D')->setWidth(10, 'pt');
...
$activeSheet->getColumnDimension('S')->setWidth(7, 'pt');
