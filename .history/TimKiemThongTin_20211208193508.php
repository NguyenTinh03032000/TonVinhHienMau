...
function LoadDuLieu($cboHuyen, $cboSoLanHM, $cboMucTonVinh, $cboNhomMau, $txtTimKiem)
{
    ...
    } else if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboNhomMau != "null") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "'";
    } else if ($cboHuyen != "null" and $cboSoLanHM != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboHuyen != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "'";
    } else if ($cboHuyen != "null" and $cboMucTonVinh != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboHuyen != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null") {
        $timkiem = "nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "'";
    } else if ($cboSoLanHM != "null" and $cboMucTonVinh != "null" and $txtTimKiem != "") {
        $timkiem = "nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboSoLanHM != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
        $timkiem = "nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "'  and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboMucTonVinh != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
        $timkiem = "danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "'";
    } else if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboMucTonVinh != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
        $timkiem = "nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    } else if ($cboHuyen != "null" and $cboSoLanHM != "null" and $cboMucTonVinh != "null" and $cboNhomMau != "null" and $txtTimKiem != "") {
        $diachi = "%" . $cboHuyen . "%";
        $timkiem = "nguoihienmau.DiaChi like '" . $diachi . "' and nguoihienmau.SoLanHienMau = '" . $cboSoLanHM . "' and danhsachtonvinh.MucTonVinh = '" . $cboMucTonVinh . "' and nguoihienmau.NhomMau = '" . $cboNhomMau . "' and nguoihienmau.HoTen like '" . $timkiem . "'";
    }

    $sql = "select * from nguoihienmau INNER JOIN danhsachtonvinh ON nguoihienmau.ID_NguoiHienMau = danhsachtonvinh.ID_NguoiHienMau INNER JOIN donvi ON donvi.madonvi = danhsachtonvinh.MaDonVi where " . $timkiem;
