    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar" style="justify-content: center;">
        <ul class="navbar-nav justify-content-center">
            ...
            if (!(isset($_SESSION['Username']) && $_SESSION['Username'] != '')) {
                echo '
                    <li class="nav-item active">
                        <a class="nav-link" href="DangNhapQuanTri.php">Quản lý khoa</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="DangNhapQuanTri.php">Quản lý ngành học</a>
                    </li> 
                    <li class="nav-item active">
                        <a class="nav-link" href="DangNhapQuanTri.php">Quản lý khóa học</a>
                    </li> 
                    <li class="nav-item active">
                        <a class="nav-link" href="DangNhapQuanTri.php">Quản lý lớp học</a>
                    </li>   
                    <li class="nav-item active">
                ...
                echo '
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu bg-light">
                            <a class="dropdown-item" href="ThongTinQuanTri.php">Thông tin tài khoản</a>
                            <a class="dropdown-item" href="DoiMatKhauQuanTri.php">Đổi mật khẩu</a>
