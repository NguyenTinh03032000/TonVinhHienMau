...
function CapNhatHD($username, $txtHoTen, $dateNgaySinh, $txtSDT, $txtDiaChi, $txtEmail)
{
    include "bocuc/Connect.php";

    $sql = "update tk_canbo set hoten = '" . $txtHoTen . "', 
    ...
    if ($kq) {
        ...
        echo "<script>alert('Không thể cập nhật. Vui lòng thử lại sau!!!');</script>";
    }
}

if ($_POST) {
    if (isset($_POST['btnUpdate']) and $_SERVER['REQUEST_METHOD'] == "POST") {
        CapNhatHD($username, $txtHoTen, $dateNgaySinh, $txtSDT, $txtDiaChi, $txtEmail);
    }
}
