        ...
        if ($rowdonvi['dem'] != 0) {
            ...
            while ($row = mysqli_fetch_array($kq)) {
                ...
                echo '<tr>
                        ...
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 5, $row['ID_NguoiHienMau']) . '>' . $muc5 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 10, $row['ID_NguoiHienMau']) . '>' . $muc10 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 15, $row['ID_NguoiHienMau']) . '>' . $muc15 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 20, $row['ID_NguoiHienMau']) . '>' . $muc20 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 30, $row['ID_NguoiHienMau']) . '>' . $muc30 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 40, $row['ID_NguoiHienMau']) . '>' . $muc40 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 50, $row['ID_NguoiHienMau']) . '>' . $muc50 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 60, $row['ID_NguoiHienMau']) . '>' . $muc60 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 70, $row['ID_NguoiHienMau']) . '>' . $muc70 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 80, $row['ID_NguoiHienMau']) . '>' . $muc80 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 90, $row['ID_NguoiHienMau']) . '>' . $muc90 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh_NguoiHienMau($matonvinh, 100, $row['ID_NguoiHienMau']) . '>' . $muc100 . '</p>
                        </td>
                        <td>
                            <p></p>
                        </td>
