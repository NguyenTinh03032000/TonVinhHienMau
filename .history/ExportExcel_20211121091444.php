...
$activeSheet->setCellValue('D3', 'Mức 70');
$activeSheet->setCellValue('P3', 'Mức 80');
$activeSheet->setCellValue('Q3', 'Mức 90');
$activeSheet->setCellValue('R3', 'Mức 100');

$count = 4;

while ($row = mysqli_fetch_array($kq)) {
    $activeSheet->setCellValue('A' . $count, $row["HoTen"]);
    $activeSheet->setCellValue('B' . $count, $row["NgaySinh"]);
    $activeSheet->setCellValue('C' . $count, $row["NhomMau"]);
    $activeSheet->setCellValue('D' . $count, $row["SDT"]);
