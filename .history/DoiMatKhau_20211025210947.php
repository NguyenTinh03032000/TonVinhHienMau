            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <form action="DoiMatKhau.php" class="needs-validation" method="POST" novalidate>
                        ...
                        <div class="form-group">
                            <input type="passwordt" class="form-control" style="font-size: 25px; border-radius: 20px;" id="tieude" placeholder="Nhập lại mật khẩu mới" name="txtNhapLaiMatKhauMoi" required autocomplete="off">
                            <div class="valid-feedback">Hợp lệ.</div>
                            <div class="invalid-feedback">Vui lòng không được bỏ trống thông tin!</div>
                        </div>
