...
// Chiều dài cột
$activeSheet->getColumnDimension('H')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('I')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('J')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('K')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('L')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('M')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('N')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('O')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('P')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('Q')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('R')->setWidth(1, 'pt');
$activeSheet->getColumnDimension('S')->setWidth(1, 'pt');
