    ...
    while ($rowdonvi = mysqli_fetch_array($kqdonvi)) {
        if ($rowdonvi['dem'] != 0) {
            ...
            while ($row = mysqli_fetch_array($kq)) {
                ...
                $hienthimuc5 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 5);
                $hienthimuc10 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 10);
                $hienthimuc15 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 15);
                $hienthimuc20 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 20);
                $hienthimuc30 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 30);
                $hienthimuc40 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 40);
                $hienthimuc50 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 50);
                $hienthimuc60 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 60);
                $hienthimuc70 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 70);
                $hienthimuc80 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 80);
                $hienthimuc90 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 90);
                $hienthimuc100 = KiemTraMucTonVinh_NguoiHienMau($matonvinh, 100);
                ...
                echo '<tr>
                        ...
                        <td>
                            <p ' . $hienthimuc5 . '>' . $muc5 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc10 . '>' . $muc10 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc15 . '>' . $muc15 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc20 . '>' . $muc20 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc30 . '>' . $muc30 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc40 . '>' . $muc40 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc50 . '>' . $muc50 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc60 . '>' . $muc60 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc70 . '>' . $muc70 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc80 . '>' . $muc80 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc90 . '>' . $muc90 . '</p>
                        </td>
                        <td>
                            <p ' . $hienthimuc100 . '>' . $muc100 . '</p>
                        </td>
                        <td>
                            <p></p>
                        </td>
