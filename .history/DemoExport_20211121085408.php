...
if (isset($_POST["export"])) {
    ...
    $active_sheet->setCellValue('A3', 'First Name');
    $active_sheet->setCellValue('B3', 'Last Name');
    $active_sheet->setCellValue('C3', 'Created At');
    $active_sheet->setCellValue('D3', 'Updated At');
