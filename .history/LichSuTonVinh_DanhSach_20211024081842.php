                    ...
                    ?>
                        ...
                        <div class="tab-content border">
                            ...
                            <div id="menu1" class="container-fluid tab-pane active"><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <select class="form-control" name="cboDotTonVinh">
                                            <option value="">-- Chọn đợt tôn vinh --</option>
                                            <?php
                                    ...
                                    <div class="col-lg-4">
                                        <select class="form-control" name="cboMucTonVinh">
                                            <option value="">-- Chọn mức tôn vinh --</option>
                                            <?php
                                            $muctonvinh = 0;
                                            for ($i = 0; $i <= 20; $i++) {
                                                $muctonvinh += 5;
                                                echo '<option value="' . $muctonvinh . '">' . $muctonvinh . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
...
function TimKiem($cboDotTonVinh, $cboMucTonVinh)
{
    ...
    $sql = "SELECT * FROM danhsachtonvinh INNER JOIN tonvinh ON tonvinh.matonvinh = danhsachtonvinh.MaTonVinh 
                                            INNER JOIN nguoihienmau.ID_NguoiHienMau = danhsachtonvinh.ID_NguoiHienMau 
                                            INNER JOIN donvi ON donvi.madonvi = danhsachtonvinh.MaDonVi 
                                            where MaTonVinh = '" . $cboDotTonVinh . "' and MucTonVinh = '" . $cboMucTonVinh . "'";
    $kq = mysqli_query($kn, $sql) or die("lỗi truy vấn");
}
...
if ($_POST) {
    ...
    if (isset($_POST['btnXoa']) and $_SERVER['REQUEST_METHOD'] == "POST") {
        XoaDotTonVinh($cboDotTonVinh, $cboMucTonVinh);
    }
}
