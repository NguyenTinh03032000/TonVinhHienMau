...
function TimKiem_1($matonvinh, $cboDonVi)
{
    ...
    if ($cboDonVi == "null") {
        ...
        echo '<tr>
                ...
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 5, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 10, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 15, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 20, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 30, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 40, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 50, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 60, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 70, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 80, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 90, $cboDonVi) . '</h5>
                </td>
                <td style="vertical-align: inherit;">
                    <h5>' . TongMuc($matonvinh, 100, $cboDonVi) . '</h5>
                </td>
            </tr>
        </tbody>';
    }
