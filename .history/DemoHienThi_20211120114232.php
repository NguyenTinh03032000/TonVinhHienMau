    ...
    while ($rowdonvi = mysqli_fetch_array($kqdonvi)) {
        if ($rowdonvi['dem'] != 0) {
            ...
            while ($row = mysqli_fetch_array($kq)) {
                ...
                echo $hienthimuc10 . "hello <br>";
                echo $hienthimuc15 . "Nguyên <br>";
                ...
                echo '<tr>
                        ...
                        <td ' . KiemTraMucTonVinh($matonvinh, 5) . '>
                            <p>' . $muc5 . '</p>
                        </td>
                        <td ' . KiemTraMucTonVinh($matonvinh, 10) . '>
                            <p>' . $muc10 . '</p>
                        </td>
                        <td ' . KiemTraMucTonVinh($matonvinh, 15) . '>
                            <p>' . $muc15 . '</p>
                        </td>
                        <td ' . $hienthimuc20 . '>
                            <p>' . $muc20 . '</p>
