...
while ($row = mysqli_fetch_array($kq)) {
    ...
    $activeSheet->setCellValue('I' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('J' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('K' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('L' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('M' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('N' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('O' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
    $activeSheet->setCellValue('P' . $count, '=COUNTIF(' . $SUMRANGE_H . ',">0")');
