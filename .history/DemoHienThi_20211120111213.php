...
function KiemTraMucTonVinh($matonvinh, $muctonvinh)
{
    ...
    $sqlMucTonVinh = "SELECT COUNT(danhsachtonvinh.MucTonVinh) as dem FROM danhsachtonvinh INNER JOIN muctonvinh ON muctonvinh.ID = danhsachtonvinh.MucTonVinh WHERE danhsachtonvinh.matonvinh = '" . $matonvinh . "' and muctonvinh.ID = '" . $muctonvinh . "'";
