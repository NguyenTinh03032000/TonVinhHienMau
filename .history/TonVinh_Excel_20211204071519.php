            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <script type="text/javascript">
                            function thaydoitonvinh() {
                                var muctonvinh = document.getElementById("cboMucTonVinh");
                                var giatritonvinh;
                                for (var i = 0; i < muctonvinh.length; i++) {
                                    if (muctonvinh[i].selected) {
                                        giatritonvinh = muctonvinh[i].value;
                                    }
                                }

                                document.getElementById("btn_Excel_1").style.display = "none";
                                document.getElementById("btn_Excel_2").innerHTML = ;
                            }
                        </script>
                    ...
                    <div class="modal-footer">
                        ...
                        <button name="btnMaTonVinh" value="<?php echo $matonvinh ?>" class="btn btn-danger btn_Excel_1">XUẤT EXCEL</button>
                        <div class="btn_Excel_2"></div>
                    </div>
