            ...
            <div class="col-sm-10">
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            <button type="button" class="btn btn-danger form-control btnThem" data-toggle="modal" data-target="#ThemSV">
                                            ...
                                            <div class="modal fade" id="XoaThongTin">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <!-- Modal body -->
                                                        <div class="modal-body">
                                                            <input type="text" class="form-control" name="txtMaSV" value="<?php echo $row['username']; ?>" id="masv" style="pointer-events: none">
