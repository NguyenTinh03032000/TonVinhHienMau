                                ...
                                <?php
                                        echo '<script type="text/javascript">
                                                function thaydoitonvinh' . $row1['ID_NguoiHienMau'] . '()
                                                {
                                                    ...
                                                    document.getElementById("btnApply_2' . $row1['ID_NguoiHienMau'] . '").innerHTML = "<a href="ThemApplyTonVinh.php?id_nguoihienmau=' . $row1['ID_NguoiHienMau'] . '&muctonvinh=giatritonvinh' . $row1['ID_NguoiHienMau'] . '">AppLy</a>";
