        ...
        if ($rowdonvi['dem'] != 0) {
            ...
            while ($row = mysqli_fetch_array($kq)) {
                ...
                echo '<tr>
                        ...
                        <td>
                            <p ';  KiemTraMucTonVinh($matonvinh, 5) echo '>' . $muc5 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 10) . '>' . $muc10 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 15) . '>' . $muc15 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 20) . '>' . $muc20 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 30) . '>' . $muc30 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 40) . '>' . $muc40 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 50) . '>' . $muc50 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 60) . '>' . $muc60 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 70) . '>' . $muc70 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 80) . '>' . $muc80 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 90) . '>' . $muc90 . '</p>
                        </td>
                        <td>
                            <p ' . KiemTraMucTonVinh($matonvinh, 100) . '>' . $muc100 . '</p>
                        </td>
                        <td>
                            <p></p>
                        </td>
