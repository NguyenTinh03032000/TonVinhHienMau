...
if (isset($_FILES['fileBenhVien']['name']) && in_array($_FILES['fileBenhVien']['type'], $file_mimes)) {
    ...
    if (!empty($sheetData)) {
        for ($i = 1; $i < count($sheetData); $i++) {
            ...
            // $date = $nam . "-" . $thang . "-" . $ngay;
            $date = date("Y-m-d", $cot5);

            if ($cot1 != "" and $cot1 != "STT") {
                echo $cot1 . " - " . $cot2 . " - " . $date . " - " . $cot7 . " - " . $cot9 . " - " . $cot11 . " - " . $cot12 . " - " . $cot17 . " - " . $cot19 . " - " . $cot20 . " - " . $cot21 . " - " . $cot22 . "<br>";

                // $sql = "inser into excel_benhvien (HoTen, NgaySinh, NgheNghiep, NoiLamViec, SDT, DiaChi, SoLanHienMau, NhomMau, Mhom_RH, TenFile, create_at, update_at)
                //             values('" . $cot2 . "', '" . $date . "', '" . $cot7 . "', '" . $cot9 . "', '" . $cot11 . "', '" . $cot12 . "', '" . $cot17 . "', '" . $cot21 . "', '" . $cot22 . "', '" . $cot2 . "', '" . $cot2 . "')";
