...
function KiemTraMucTonVinh($matonvinh, $muctonvinh)
{
    ...
    $sqlMucTonVinh = "SELECT DISTINCT danhsachtonvinh.MucTonVinh FROM danhsachtonvinh INNER JOIN muctonvinh ON muctonvinh.ID = danhsachtonvinh.MucTonVinh WHERE danhsachtonvinh.matonvinh = '" . $matonvinh . "'";
    $kqMucTonVinh = mysqli_query($kn, $sqlMucTonVinh) or die("lỗi truy vấn 1");
    while ($rowMucTonVinh = mysqli_fetch_array($kqMucTonVinh)) {
        // if ($rowMucTonVinh['MucTonVinh'] == "5") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "10") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "15") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "20") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "30") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "40") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "50") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "60") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "70") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "80") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "90") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "100") {
        //     echo "hidden";
        // } else if ($rowMucTonVinh['MucTonVinh'] == "null") {
        //     echo "hidden";
        // }
        if ($rowMucTonVinh['MucTonVinh'] != $muctonvinh) {
            echo "hidden";
        } else if ($rowMucTonVinh['MucTonVinh'] == "null") {
            echo "hidden";
        }
                ...
                ?>
                    <table class="table table-bordered" style="width: 100%">
                        <tr>
                            ...
                            <td>Nghề nghiệp</td>
                            <td>Địa chỉ</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 5</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 10</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 15</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 20</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 30</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 40</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 50</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 60</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 70</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 80</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 90</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Mức 100</td>
                            <td <?php KiemTraMucTonVinh($matonvinh) ?>>Ghi chú</td>
                        </tr>
                        <?php
                        TimKiem($matonvinh);
                        ?>
