...
// Chiều dài cột
$activeSheet->getColumnDimension('H')->setWidth(100, 'cm');
$activeSheet->getColumnDimension('I')->setWidth(100, 'cm');
$activeSheet->getColumnDimension('J')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('K')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('L')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('M')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('N')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('O')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('P')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('Q')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('R')->setWidth(1, 'cm');
$activeSheet->getColumnDimension('S')->setWidth(1, 'cm');
