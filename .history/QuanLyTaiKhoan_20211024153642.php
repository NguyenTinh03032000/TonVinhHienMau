        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-xl-9">
                            <input class="form-control" id="tim1" type="text" placeholder="Tìm kiếm...">
                        </div>
                        <div class="col-xl-3">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center; vertical-align: inherit;">
                                            <button type="button" class="btn btn-link CapNhatThongTinSV" data-bs-toggle="modal" data-bs-target="#ChiTietThongTin">
                                            ...
                                            <div class="modal fade" id="XoaThongTin">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <!-- Modal body -->
                                                        <div class="modal-body">
                                                            <input type="text" class="form-control" name="txtMaSV" value="<?php echo $row['username']; ?>" style="pointer-events: none">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
                                                            <button type="submit" class="btn btn-primary btnDelete" name="btnXoaSV">Xóa thông tin</button>
                                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Mã đăng nhập:</p>
                                                <input type="text" class="form-control" name="txtUsername_update" style="font-size: 18px;">
                                            </div>
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Họ và tên:</p>
                                                <input type="text" class="form-control" name="txtTen_update" style="font-size: 18px;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                            ...
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Địa chỉ:</p>
                                                <input type="text" class="form-control" name="txtDiaChi_update" style="font-size: 18px;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Số điện thoại:</p>
                                                <input type="text" class="form-control" name="txtSDT_update" style="font-size: 18px;">
                                            </div>
                                            <div class="col-sm-6" style="justify-content: center;display: block;">
                                                <p>Email:</p>
                                                <input type="email" class="form-control" name="txtEmail_update" placeholder="name@example.com" style="font-size: 18px;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12" style="justify-content: center;display: block;">
                                                <p>Mật khẩu:</p>
                                                <input type="password" class="form-control" name="txtPass_update" placeholder="name@example.com" style="font-size: 18px;">
                                            </div>
                                            <div class="col-sm-12" style="justify-content: center;display: block;">
                                                <p>Quyền đăng nhập:</p>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btnUpdate" name="btnCapNhat">Cập nhật</button>
                                    </div>
