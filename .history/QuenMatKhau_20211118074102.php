...
<body>
    ...
    <div class="container-fluid" style="margin-top:30px; margin-bottom:30px;">
        <div class="row">
            ...
            <div class="col-sm-4" style="margin-bottom:30px; margin-top: 150px;">
                ...
                <form action="" class="needs-validation" method="POST" novalidate>
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="margin: auto;">
                            <button type="submit" class="btn btn-danger btn-block" style="margin: auto; display: block; font-size: 25px;  border-radius: 6px;" name="btnQuenMatKhau">GỬI</button>
                        </div>
                    </div>
