                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6" style="justify-content: center;display: block;">
                                                    <p>Mật khẩu:</p>
                                                    <input type="password" class="form-control" name="txtPass_update" id="txtPass_update" placeholder="Nhập mật khẩu">
                                                </div>
                                                <div class="col-sm-6" style="justify-content: center;display: block;">
                                                    <p>Quyền đăng nhập:</p>
...
{
    include "bocuc/Connect.php";
    if (($txtUsername == "") || ($txtTen == "") || ($dateNgaysinh == "") || ($txtDiaChi == "") || ($txtSDT == "") || ($txtEmail == "") || ($txtPassWord == "")) {
...
function capNhatTaiKhoan($txtUsername_update, $txtTen_update, $dateNgaysinh_update, $txtDiaChi_update, $txtSDT_update, $txtEmail_update, $txtPass_update, $cboQuyen_update)
{
    ...
    date_default_timezone_set('Asia/Ho_Chi_Minh');
    $date = date('d-m-y h:i:s');
    if (($txtUsername_update == "") || ($txtTen_update == "") || ($dateNgaysinh_update == "") || ($txtDiaChi_update == "") || ($txtSDT_update == "") || ($txtEmail_update == "") || ($txtPassWord_update == "")) {
        echo '<meta http-equiv="refresh" content="0">';
        echo "<script>alert('Vui lòng nhập đẩy đủ thông tin!!!');</script>";
    } else {
