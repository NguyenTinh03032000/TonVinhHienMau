            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <script type="text/javascript">
                            function thaydoitonvinh ' . $row1['
                            ID_NguoiHienMau '] . '() {
                                var muctonvinh ' . $row1['
                                ID_NguoiHienMau '] . ' = document.getElementById("cboMucTonVinh' . $row1['ID_NguoiHienMau'] . '");
                                var giatritonvinh ' . $row1['
                                ID_NguoiHienMau '] . ';
                                for (var i = 0; i < muctonvinh ' . $row1['
                                    ID_NguoiHienMau '] . '.length; i++) {
                                    if (muctonvinh ' . $row1['
                                        ID_NguoiHienMau '] . ' [i].selected) {
                                        giatritonvinh ' . $row1['
                                        ID_NguoiHienMau '] . ' = muctonvinh ' . $row1['
                                        ID_NguoiHienMau '] . ' [i].value;
                                    }
                                }

                                document.getElementById("btnApply' . $row1['ID_NguoiHienMau'] . '").style.display = "none";
                                document.getElementById("btnApply_1' . $row1['ID_NguoiHienMau'] . '").innerHTML = "' . $chuoidau . '' . $row['ID'] . '' . $chuoigiua_1 . '' . $row1['ID_NguoiHienMau'] . '' . $chuoigiua_2 . '" + giatritonvinh ' . $row1['
                                ID_NguoiHienMau '] . ' + "' . $chuoigiua_3 . '' . $madonvi . '' . $chuoigiua_4 . '' . $matonvinh . '' . $chuoicuoi . '";
                            }

                            function XuLyRieng ' . $row1['
                            ID_NguoiHienMau '] . '() {
                                document.getElementById("btnApply' . $row1['ID_NguoiHienMau'] . '").style.display = "none";
