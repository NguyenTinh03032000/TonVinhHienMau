                            ...
                            <div class="row">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="XacNhanKetQua.php<?php echo $row_dottonvinh['matonvinh'] ?>" class="btn btn-secondary btnxn1" name="btnxn">Xác nhận</a>
                                                        </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        ?>
                                            <div class="tab-pane container " id="muc<?php echo $row1['muctonvinh']; ?>">
                                                <?php
                                                        ...
                                                        <table class="table table-bordered table-hover" style="width:100%">
                                                            <thead>
                                                                <tr style="text-align: center">
                                                                    ...
                                                                    <th style="text-align: center; vertical-align: inherit;">Số lần hiên máu</th>
                                                                    <th style="text-align: center; vertical-align: inherit;">Nhóm máu</th>
                                                                    ...
                                                                    <th style="text-align: center; vertical-align: inherit;">Đã tôn vinh</th>
                                                            ...
                                                            <tbody id="myTable">
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center;vertical-align: inherit;">
                                                                            <select id="cboMucTonVinh<?php echo $row['ID']; ?>" onchange="thaydoimuctonvinh<?php echo $row['ID']; ?>()">
                                                                                <?php
                                                                        ...
                                                                        <td style="text-align: center; vertical-align: inherit;">
                                                                            <p class="button button1">
                                                                                <a data-toggle="tooltip" data-placement="top" title="<?php echo "Đã tôn vinh đợt: ";
                                                                                                                                        echo $row['MaTonVinh'] ?>"><?php echo $row['MucTonVinh']; ?></a>
