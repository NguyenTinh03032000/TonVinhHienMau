...
<body>
    ...
    if (isset($_POST['btnThemQT'])) {
        $file = $_FILES['txtThemQT']['tmp_name'];
        ...
        foreach ($objReader->getWorksheetIterator() as $workSheet) {
            ...
            for ($row = 2; $row < $highestRow; $row++) {
                $maqt2 = $workSheet->getCellByColumnAndRow(0, $row)->getValue();
                $hoten2 = $workSheet->getCellByColumnAndRow(1, $row)->getValue();
                $ngaysinh2 = $workSheet->getCellByColumnAndRow(2, $row)->getValue();
                $gioitinh2 = $workSheet->getCellByColumnAndRow(3, $row)->getValue();
                $sdt2 = $workSheet->getCellByColumnAndRow(4, $row)->getValue();
                $email2 = $workSheet->getCellByColumnAndRow(5, $row)->getValue();
                ...
                // if ($maqt != '') {
                //     $sqlThem = "insert into quantri (MaQuanTri, HoTen, NgaySinh, GioiTinh, SDT, Email, MatKhau)
                //                 values ('$maqt2', '$hoten2', '$date2', '$gioitinh2', '$sdt2', '$email2', '$maqt2')";
                //     $kq2 = mysqli_query($kn, $sqlThem) or die("lỗi truy vấn");
                // }
                echo $maqt2 + ", " + $hoten2 + ", " + $ngaysinh2 + ", " + $gioitinh2 + ", " + $sdt2 + ", " + $email2;
            }
    ...
    if (isset($_POST['btnXoaQT'])) {
        $maqt = $_POST['txtMaQT'];

        $sql1 = "delete from quantri where MaQuanTri = '" . $maqt . "'";
    ...
    if (isset($_POST['btnCapNhatThongTinQT'])) {
        ...
        if ($sdt1 == "" or $email1 == "") {
            ...
            $sql1 = "update quantri set SDT = '$sdt1', 
                                        Email = '$email1',
                                        MatKhau = '$txtmatkhau1'
                                        where MaQuanTri = '$maqt1'";
            $kq1 = mysqli_query($kn, $sql1);
    ...
    if (isset($_POST['btnLuuSV'])) {
        $txtMQT = array_key_exists('txtMQT', $_POST) ? $_POST["txtMQT"] : null;
                            ...
                            <div class="tab-content">
                                <div id="menu1" class="container-fluid tab-pane active border border-primary"><br>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="exel1" class="container tab-pane fade"><br>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="file" name="txtThemQT">
                                                            </div>

                                                            <!-- Modal footer -->
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-primary" name="btnThemQT">Thêm</button>
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div style="overflow: scroll;height: 1000px;" class="table-responsive">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <p>Mã quản trị:</p>
                                                                <input type="text" class="form-control" name="txtmaqt1" id="maqt1" placeholder="Mã quản trị" style="pointer-events: none">
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <p>Họ tên:</p>
                                                        ...
                                                        <hr>
                                                        <h5>Bạn có chắc chắn muốn cập nhật thông tin này không?</h5>
                                                    </div>
                                        ...
                                        <!-- The Modal xóa quản trị -->
                                        <div class="modal fade" id="XoaQT">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">

                                                    <!-- Modal Header -->
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Xóa thông tin quản trị</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <p>Mã quản trị:</p>
                                                                <input type="text" class="form-control" name="txtMaQT" id="maqt" style="pointer-events: none">
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <p>Họ tên:</p>
                                                                <input type="text" class="form-control" id="hotenqt" style="pointer-events: none">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <h5>Bạn có chắc chắn muốn xóa thông tin này không?</h5>
                                                    </div>

                                                    <!-- Modal footer -->
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary" name="btnXoaQT">Xóa thông tin</button>
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
                                                    </div>
...
<script>
    // Gọi modal xóa quản trị 
    $(document).ready(function() {
        $('.XoaQT').on('click', function() {
            $('#XoaQT').modal('show');
            ...
            $('#maqt').val(data[0].trim());
            $('#hotenqt').val(data[1].trim());
        });
    });
