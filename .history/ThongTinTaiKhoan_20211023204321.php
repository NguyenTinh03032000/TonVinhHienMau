                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <br>
                            <button type="button" class="btn btn-danger btnUpdate" data-toggle="modal" data-target="#modalUpdate" style="margin: auto;">CẬP NHẬT</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                ...
                                                <p>Ngày sinh</p>
                                                <input type="date" class="form-control" value="<?php echo htmlspecialchars(date_format(date_create($row['ngaysinh']), "Y-m-d"));  ?>">
                                                <p>Số điện thoại</p>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-secondary btnUpdate1" name="btnCapNhat">Cập nhật</button>
                                        </div>
                        ...
                        <div class="col-sm-8">
                            <table>
                                ...
                                <tr>
                                    <td>Ngày sinh:</td>
                                    <td><?php echo htmlspecialchars(date_format(date_create($row['ngaysinh']), "d/m/Y"));  ?></td>
                                </tr>
                                <tr>
                                    <td>Số điện thoại:</td>
...
function CapNhatHD($txtMaHoatDong1, $txtTenHoatDong1, $dateNgayDienRa1, $txtThoiGanDR1, $txtNoiDung1, $cboNamHoc1, $cboHocKy1, $cboCapDienRa1, $txtKhoaThamGia1, $txtSoLuong1, $File1)
{
    include "bocuc/Connect.php";

    $sql1 = "update hoatdong set TenHoatDong = '" . $txtTenHoatDong1 . "', 
                                        NgayDienRa = '" . $dateNgayDienRa1 . "',
                                        ThoiGianDienRa = '" . $txtThoiGanDR1 . "', 
                                        NoiDung = '" . $txtNoiDung1 . "', 
                                        NamHoc = '" . $cboNamHoc1 . "', 
                                        HocKy = '" . $cboHocKy1 . "',
                                        CapDienRa = '" . $cboCapDienRa1 . "',
                                        KhoaThamGia = '" . $txtKhoaThamGia1 . "', 
                                        SoLuong = '" . $txtSoLuong1 . "',
                                        File = '" . $File1 . "'
