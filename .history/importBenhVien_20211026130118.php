    ...
    if (!empty($sheetData)) {
        for ($i = 1; $i < count($sheetData); $i++) {
            ...
            if ($cot1 != "" and $cot1 != "STT") {
                ...
                $sql = "insert into excel_benhvien (ID, HoTen, NgaySinh, NgheNghiep, NoiLamViec, SDT, DiaChi, SoLanHienMau, NhomMau, Mhom_RH, TenFile, create_at)
                            values('', '" . $cot2 . "', '" . $date . "', '" . $cot7 . "', '" . $cot9 . "', '" . $cot11 . "', '" . $cot12 . "', '" . $cot17 . "', '" . $cot21 . "', '" . $cot22 . "', '" . $tenfile . "')";
