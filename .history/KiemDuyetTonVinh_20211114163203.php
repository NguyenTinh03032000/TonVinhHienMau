                                            ...
                                            <td colspan="11">
                                                <div class="grp-btn">
                                                    ...
                                                    if ($row1['dem'] == 0) {
                                                        ...
                                                        <!-- <a id="btnApply_2<?php echo $row1['ID_NguoiHienMau'] ?>" href="ThemApplyTonVinh.php?id_nguoihienmau=&muctonvinh=">AppLy</a> -->
                                                        <small id="btnApply_3<?php echo $row1['ID_NguoiHienMau'] ?>"></small>
                                                    <?php } ?>
                                ...
                                <?php
                                        echo '<script type="text/javascript">
                                                function thaydoitonvinh' . $row1['ID_NguoiHienMau'] . '()
                                                {
                                                    ...
                                                    document.getElementById("btnApply_3' . $row1['ID_NguoiHienMau'] . '").innerHTML = "<a class="btn btn-danger" href="ThemApplyTonVinh.php?id_nguoihienmau=' . $row1['ID_NguoiHienMau'] . '&muctonvinh=giatritonvinh' . $row1['ID_NguoiHienMau'] . '">AppLy</a>";
                                                    // document.getElementById("btnApply_3' . $row1['ID_NguoiHienMau'] . '").innerHTML = "Số điểm đã chọn: " + giatritonvinh' . $row1['ID_NguoiHienMau'] . ';
                                                }
                                                </script>';
                                    }
                                }  ?>
