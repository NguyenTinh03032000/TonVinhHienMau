...
function TimKiem_1($matonvinh, $cbocboDonVi, $cbocboMucTonVinh)
{
    ...
    while ($rowdonvi = mysqli_fetch_array($kqdonvi)) {
        ...
        while ($row = mysqli_fetch_array($kq)) {
            ...
            if($cbocboMucTonVinh == "5"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc5 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "10"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc10 . '</p>
                </td>';
            if($cbocboMucTonVinh == "15"){
                    echo '<td style="vertical-align: inherit;">
                    <p>' . $muc15 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "20"){
                    echo '<td style="vertical-align: inherit;">
                    <p>' . $muc20 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "30"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc30 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "40"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc40 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "50"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc50 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "60"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc60 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "70"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc70 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "80"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc80 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "90"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc90 . '</p>
                </td>';
            }
            if($cbocboMucTonVinh == "100"){
                echo '<td style="vertical-align: inherit;">
                    <p>' . $muc100 . '</p>
                </td>';
            }
