...
<body>
    ...
    ?>
        ...
        <form action="ThemApplyTonVinh.php" method="POST">
                                    ...
                                    while ($row1 = mysqli_fetch_array($kq1)) { ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="cboMucTonVinh<?php echo $row1['ID_NguoiHienMau'] ?>" onchange="thaydoitonvinh<?php echo $row1['ID_NguoiHienMau'] ?>()">
                                                        <?php
                                                    ...
                                                    function tinhhoatdong' . $rowMuc3_1['MaHoatDong'] . '()
                                                    {
                                                        var hoatdong' . $rowMuc3_1['MaHoatDong'] . ' = document.getElementById("hoatdong' . $rowMuc3_1['MaHoatDong'] . '");
                                                        var giatrihoatdong' . $rowMuc3_1['MaHoatDong'] . ';
                                                        for (var i = 0; i < hoatdong' . $rowMuc3_1['MaHoatDong'] . '.length; i++){
                                                            if (hoatdong' . $rowMuc3_1['MaHoatDong'] . '[i].selected){
                                                                giatrihoatdong' . $rowMuc3_1['MaHoatDong'] . ' = hoatdong' . $rowMuc3_1['MaHoatDong'] . '[i].value;
                                                                mang3_1.push(giatrihoatdong' . $rowMuc3_1['MaHoatDong'] . ');
                                                            }
                                                        }
                                                        document.getElementById("hoatdong' . $rowMuc3_1['MaHoatDong'] . '").style.display = "none";
                                                        document.getElementById("diemhoatdong' . $rowMuc3_1['MaHoatDong'] . '").innerHTML = "Số điểm đã chọn: " + giatrihoatdong' . $rowMuc3_1['MaHoatDong'] . ';
                                                    }
                                                </script>';
                                                        } ?>
                                                        <!-- The Modal -->
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <b><button type="submit" name="btnSave" class="btn btn-success" data-dismiss="modal">Save</button></b>
